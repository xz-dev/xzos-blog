...
description: "从滞涨、AI 基建、循环投资到 IPO，记录 AI 泡沫最后阶段如何把未来风险分发给全社会。"
author: "xz-dev"
category: "AI"
tags: ["AI", "AI 泡沫", "金融", "宏观", "滞涨", "黄金", "美元", "OpenAI", "NVIDIA", "SpaceX", "IPO", "数据中心", "资本市场"]
---
...
> <small style="opacity: 0.65; font-size: 0.92em;">注释：世界银行说，2020–2024 年将成为 30 年来全球增长最弱的五年；IMF 也把当时的世界经济形容为 “still limping along”。[WG1][WG2]</small>
...
它不一定是财务造假，也不一定是阴谋，但它会让真实需求和资本需求缠在一起，让投资、收入、股权、合同和市场信心互相喂养。NVIDIA 投资 OpenAI，OpenAI 采购 NVIDIA 系统；OpenAI 与云厂商签巨额算力合同，云厂商拿合同融资、上市、扩建，再反过来支撑 OpenAI 的算力叙事。NVIDIA 宣布最高 1000 亿美元投资 OpenAI，并与 OpenAI 合作部署 10GW NVIDIA systems，正是这类结构里最具代表性的节点。[O6][O7][O14]
...
闪存这一段，真正让我觉得不对劲的，不是“AI 需要存储”这件事本身。AI 当然需要存储，数据中心当然需要 SSD，长上下文、RAG、向量数据库、KV cache 也当然会增加读写压力。问题是：LLM 已经火了这么久，难道以前的闪存就不要钱吗？为什么偏偏到了 2025 年末，AI FOMO 开始被 circular deals、数据中心资本开支和盈利问题反复质疑的时候，memory / NAND / enterprise SSD 突然被推成了新的稀缺资产？

这才是可疑的地方。

时间线非常微妙。2025 年 10 月，Bloomberg 已经开始用 circular deals 描述 OpenAI、NVIDIA、AMD、Oracle 等 AI 交易网络，说这些互相交织的交易正在引发市场对 AI boom 是否被交易结构自己撑起来的担忧。[O14] 同一时期，Reuters 也开始把 AI bubble 放进市场讨论。11 月，NVIDIA 财报虽然暂时安抚了市场，但 Reuters 标题里已经直接出现 “AI bubble jitters”；到 12 月，Oracle、Broadcom 和 Meta 的 AI capex 继续让市场重新担心估值过热。[F11][F12]

也就是说，2025 年末的市场气氛不是单纯的“AI 永远上涨”。恰恰相反，AI 叙事开始出现疲劳：投资者开始问，模型公司到底能不能赚钱，云厂商的数据中心开支会不会太大，NVIDIA 的增长是不是已经被循环交易和资本开支预期推得太高。

就在这个窗口，闪存和 memory 被推到了台前。

Reuters 10 月 20 日已经写出第一条线索：AI boom 正在推高那些“不那么性感”的 memory 价格。它的机制不是 LLM 直接吃掉所有 NAND，而是 AI 芯片竞赛让芯片厂商把产能、投资和优先级转向 HBM、服务器内存和高端 AI 相关产品，结果反过来挤压 smartphones、computers 和 servers 里使用的传统 memory 供给。[F13] 11 月 14 日，Reuters 又报道 Samsung 把部分 memory chip 价格较 9 月最高上调 60%，一些客户开始 panic buying。[F14]

到 12 月 3 日，Reuters 直接把这件事定性成 global supply chain crisis：AI 和消费电子公司被迫争夺越来越少的 memory chip 供应，价格 soaring；Microsoft、Google、ByteDance 等科技巨头都在抢 Micron、Samsung、SK hynix 的供货。Reuters 还把机制说得很清楚：由 NVIDIA 和 Google、Microsoft、Alibaba 等巨头推动的高端 AI 芯片胃口，让芯片厂仍然无法生产足够的高端半导体；但它们向 AI 相关产品倾斜，又反过来卡住了 smartphone、PC 和消费电子所需的传统 memory。[F15]

TrendForce 的数据把这个过程量化了。2025 年三季度，企业 SSD 价格和出货同时上升，前五大 enterprise SSD 品牌合计收入环比增长 28%，达到约 65.4 亿美元，创下当年新高；TrendForce 还说，市场已经 tilted in favor of sellers，并预计四季度 enterprise SSD 合约价还会再涨 25% 以上。[F16] 这不是普通复苏，而是卖方市场重新出现。

随后涨幅开始失控。TrendForce 1 月预测，NAND Flash 需求正在分裂成消费端和 AI 端，enterprise SSD 正成为最大板块；在 NAND 供应商 disciplined capacity management 和服务器需求挤占其他应用的情况下，2026 年一季度所有 NAND Flash 产品合约价预计上涨 33–38%，client SSD 至少上涨 40%。[F3] 到 2026 年一季度，TrendForce 说，CSP 为建设 AI server infrastructure，需要高速数据传输和巨大存储容量；传统 HDD 结构性短缺又把订单推向 QLC enterprise SSD；结果前五大 NAND Flash 供应商合计收入环比跳升 83.7%，超过 389 亿美元。[F4] 另一份 6 月报告则显示，AI Agent 服务快速采用和 CSP 采购推动 enterprise SSD 收入一季度环比暴涨 86.1%，超过 184.6 亿美元；供应商库存跌到历史低位，产出落后于订单增长，厂商在紧供应下积极涨价，enterprise SSD 合约价一季度约上涨 80%。[F5]

所以问题不是“有没有需求”。当然有需求。问题是这个需求叙事出现得太及时、太整齐、太适合给 AI 泡沫续命。

当市场开始质疑 OpenAI、Oracle、CoreWeave、NVIDIA 这些 AI 基建链条到底有没有足够真实回报时，新的解释马上出现了：不是 AI 需求不行，而是瓶颈还没解决；不是 GPU 故事讲完了，而是 memory 也不够；不是模型公司烧钱太多，而是 data pipeline、enterprise SSD、KV cache、long-context reasoning 全都需要重新建设。NVIDIA 也在同一条线上推进：它 2025 年发布 AI Data Platform，把 DDN、Dell、HPE、IBM、NetApp、Pure Storage、VAST Data、WEKA 等存储厂商一起放进 AI enterprise infrastructure 叙事；2026 年 BlueField-4 STX 和 CMX 又进一步把 storage、DPU、GPU memory extension、KV cache 和 agentic AI 长上下文推理绑定在一起。[F8][F9][F10]

我不能说这已经证明了法律意义上的合谋。公开资料里没有价格协议，没有反垄断调查材料，也没有内部邮件能证明 Samsung、SK hynix、Micron、Kioxia、SanDisk 和 NVIDIA 私下串谋操纵价格。

但公开资料足以证明另一件事：2025 年末，在 AI FOMO 开始疲劳、AI bubble 质疑升温的时候，memory / NAND / enterprise SSD 的叙事突然从周期性硬件复苏，被重新包装成 AI 基建瓶颈。这个时间点太巧，涨幅太大，配套报道太整齐，以至于它看起来不像单纯的自然需求释放，更像一次产业链共同完成的叙事续命。

它不一定是阴谋，但它完成了阴谋才需要完成的功能：制造稀缺，制造恐慌采购，制造长约锁货，制造“连存储都不够”的 FOMO，并把 2026 年 IPO 大年最需要的那句话续上——AI 基建还远远不够，所以所有和 AI 基建沾边的东西都值得被重新定价。
...
真正危险的信号不是某一家公司融资，而是大家几乎同时融资。每家公司都害怕自己变成最后一个站出来要钱的人，因为最后一个融资者最容易被市场识别为“已经撑不住了”。于是抢跑本身变成了挤兑：Google 先发股权融资，OpenAI 赶紧把 confidential S-1 摆出来，Anthropic 也要排队上市，SpaceX 则把 xAI 打包进公开市场。每家公司都说自己是在为未来融资，但从市场结构看，这更像大家都看见救生艇数量有限，于是突然开始跑。
...
如果只看名字，SpaceX 像是一家航天公司上市；但如果看它自己的 S-1，意图几乎写在纸面上。SpaceX 在招股书里说，它识别出“人类历史上最大的 actionable TAM”：可量化 total addressable market 是 28.5 万亿美元，其中 Space 只有 3700 亿美元，Connectivity 约 1.6 万亿美元，AI 却是 26.5 万亿美元，约 93%。[X1] Bloomberg 也直接把这件事概括为：SpaceX 正在向 IPO 投资者营销一个 26.5 万亿美元的 AI 市场故事，而不是单纯的火箭或卫星互联网故事。[X7]

注意，TAM 不是收入预测，也不是公司已经拿到的钱；它只是公司自己圈出来的“可寻址市场”。但正因为它不是财务现实，而是估值叙事，所以更能看出这场 IPO 真正在卖什么。SpaceX 自己的 TAM 表已经把答案写出来了：公开市场真正被要求相信的，不是 3700 亿美元的 Space，也不是 1.6 万亿美元的 Connectivity，而是 26.5 万亿美元的 AI。连 Reuters Breakingviews 都把这类市场宣称称为“planet-scale absurdity”。[X8]

S-1 的经营数据进一步把这个结构拆开：2025 年，Space segment 收入约 40.86 亿美元，经营亏损 6.57 亿美元；Connectivity / Starlink 收入约 113.87 亿美元，经营利润 44.23 亿美元，Segment Adjusted EBITDA 约 71.68 亿美元；AI segment 收入约 32.01 亿美元，但经营亏损 63.55 亿美元，Segment Adjusted EBITDA 为 -12.37 亿美元。[X1] 更刺眼的是资本开支：2025 年 AI segment capex 约 127.27 亿美元，2026 年一季度 AI segment capex 又达到 77.23 亿美元。[X1]

这就是重点：Starlink 是现金流和利润，火箭、Starshield 和国防通信是可信度，xAI / Grok / AI compute 是亏损和资本开支，但也是整份招股书里最大的估值想象力来源。SpaceX IPO 不是单纯把火箭和 Starlink 卖给市场，而是用火箭、Starlink、Starshield、美国国防与通信网络这些真正有业务交集、有现金流、有工程可信度的资产，给 xAI/Grok 的亏损、AI compute 的资本开支和 X 的平台叙事做外壳。

所以这段不能写成“SpaceX 成为 Musk 平台母体”。那样太散，反而替它把故事圆顺了。更准确的说法是：Musk 借 SpaceX 的壳、Starlink 的现金流、国防通信的可信度和 Nasdaq 的指数机制，把 xAI 打包进公开市场。火箭负责让故事可信，Starlink 负责让财务报表还能看，指数机制负责把被动资金接进来，而 xAI 负责把估值空间从几千亿美元推到“26.5 万亿美元 AI TAM”的神话尺度。

这才是我觉得最像“故意把 xAI 卖掉”的地方。xAI 和 SpaceX 之间几乎没有足够自然的业务交集。所谓太空数据中心，作为远期科幻叙事可以讲；S-1 也确实把“deploy orbital AI compute at scale”和“AI infrastructure in space”写进了增长故事。[X1] 但按现实成本算，发射、维护、散热、带宽、延迟、可靠性和运维都比地面数据中心更差。只要地球上还能建数据中心，把算力搬上轨道就不是合理商业协同，而更像给 IPO 故事增加一个“只有 SpaceX 能讲”的神话接口。

没有这个包装，单独把一个高亏损、高 capex、商业模式还没证明的 xAI 推给公开市场，阻力会大得多；但被装进 SpaceX 以后，它就不再只是 xAI，它变成了“火箭 + Starlink + 国防通信 + Musk + Nasdaq 指数资金 + 26.5 万亿美元 AI TAM”的组合商品。
...
OpenAI 卖的是 ChatGPT 的信誉，Anthropic 卖的是 Claude 和 safety 的信誉，Google 卖的是 Gemini 的信誉，SpaceX 这次更像是用火箭、Starlink 和 Musk 个人信誉替 xAI / Grok / X 做信用背书。
...
Reuters 5 月报道称，SpaceX 加速 IPO 时间表并瞄准 Nasdaq；6 月 11 日，Reuters 报道 SpaceX 以每股 135 美元为这笔创纪录 IPO 定价，募资约 750 亿美元；6 月 12 日，Reuters 又确认 SpaceX 在 Nasdaq 首日交易，首日收盘估值约 2.1 万亿美元。[X2][X5][X6] Nasdaq 官方 FAQ 则把机制写得更清楚：自 2026 年 5 月 1 日起，符合条件、排名进入前 40 的新 Nasdaq 上市公司，可在上市后 15 个交易日被纳入 Nasdaq-100，并受 3x float cap 约束；Nasdaq 同时调整了市值排名口径，使 listed shares 和 unlisted shares 都可用于 eligibility / ranking market capitalization，但 unlisted shares 用于资格和排名，不用于实际权重计算。[X3]

这意味着 SpaceX 不是普通意义上的“上市后由市场慢慢选择”。在规则条件成立时，它上市后很快就可能触发指数化资金的机械买入压力。
...
### OpenClaw、Coding Plan 与 AI Agent FOMO

[OC1] 新浪科技. (2026, March 6). *腾讯楼下近千人排队安装，用户都在用 OpenClaw 做什么？*  
https://finance.sina.com.cn/tech/roll/2026-03-06/doc-inhqaham2427583.shtml

[OC2] 21经济网 / 亿欧网. (2026, March 9). *千人排队抢装 AI 顶流 OpenClaw，腾讯出手让天价代装彻底凉凉？*  
https://www.21jingji.com/article/20260309/herald/763cb0f461b6fbd9d89bc83b046c4ee6.html

[OC3] 财联社. (2026, March 9). *“龙虾”上桌，上市公司抢着“养”！OpenClaw 引爆科技圈*.  
https://www.cls.cn/detail/2306947

[OC4] 腾讯云开发者社区. (2026). *OpenClaw 这样买 Token 最划算：一文看懂各大平台 Coding Plan*.  
https://cloud.tencent.com/developer/article/2654022

[OC5] 搜狐. (2026). *OpenClaw“全民养虾”时代，哪家 Coding Plan 最适合你？国内主流 Coding Plan 套餐详解*.  
https://www.sohu.com/a/997473785_616364

[OC6] BBC News 中文. (2026). *OpenClaw 和 AI 代理热潮拆解：从“养龙虾”到“卸龙虾”*.  
https://www.bbc.com/zhongwen/articles/c93wvdn91kxo/simp

[OC7] 人民网深圳. (2026, March 9). *深圳网事丨小心“抓虾”！莫盲目跟风*.  
